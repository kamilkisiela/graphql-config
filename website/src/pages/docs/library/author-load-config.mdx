...
This function is the starting point for using GraphQL Config. It looks for a config file in [predefined search places](user-usage#config-search-places) in the current working directory.
